...
public class Planning {
    ...
    private boolean ajouterTournee(Tournee t) {
        ...
        this.nombreTotalDeCaissesLivrees += t.getNombreCaissesLivrees();
    ...
    public void planificationBasique(Depot depot, Set<Client> clients) {
        ...
        for (Client client : clients) {
            ...
            if (tourneeCourante.getNombreCaissesLivrees() + client.getNbCaisseDeBiereALivrer() > this.capaciteDesCamions) {
